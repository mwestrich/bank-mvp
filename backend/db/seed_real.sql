...
DO $$
DECLARE
    common_hash TEXT := crypt('Test123!', gen_salt('bf', 10));
BEGIN
    ...
    ('velvet98@example.com',         'Velvet Mann',        common_hash, true, NOW() - INTERVAL '88 days'),
...
BEGIN
    ...
    SELECT id INTO velvet_id FROM users WHERE email = 'velvet98@example.com';
